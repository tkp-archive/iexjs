 ...
 * @param {string} filter https://iexcloud.io/docs/api/#filter-results
 */
export const historicalFX = (symbols, from, to, on, last, first, token, version, filter) => {
...
Client.prototype.historicalFX = function(symbols, from, to, on, last, first, filter) {
    return historicalFX(symbols, from, to, on, last, first, this._token, this._version, filter);
};
